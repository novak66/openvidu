...
export default defineComponent({
    ...
    emits: ['change-camera', 'change-microphone', 'toggle-screen-share'],
...
<template>
    <div :id="'camera-' + participantIdentity" class="video-container">
        ...
        >
            ...
            <!-- NOVO: Botão de Compartilhar Tela (só aparece se for local) -->
            <div v-if="local" style="cursor: pointer" @click="$emit('toggle-screen-share')">
                <div
                    :style="{
                        width: '40px',
                        height: '40px',
                ...
                >
                    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path
                            :class="screenSharing ? 'active' : 'inactive'"
